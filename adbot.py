...
DEFAULT_CONFIG = {
    "host_usernames": ["AK.117"],
    "admin_usernames": ["AK.117"],
    "vip_usernames": [],
    "banned_users": [],
    "teleport_locations": {
...
async def main():
    ...
    room_id = os.getenv("ROOM_ID", "68345521e5acafeb515cb252")
    api_token = os.getenv("API_TOKEN", "97e5fbcc3aa7dbc21cfbb0b5551c8850b7925590f7202c4bb066137d228c1bbe")
