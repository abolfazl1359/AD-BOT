...
DEFAULT_CONFIG = {
    ...
    "language": "fa",
    "welcome_message": "<#FFD700>❤️ {username} ❤️<#00FF88>خوش امدی داداشی امید وارم لحظات خوبی سپری کنی دنس ها از <#FFD700>1<#00FF88> to<#FFD700> 250",
    "announcement_interval": 11,
    "announcement_message": "<#FFD700>❤️ سلام به مزایده شمش خوش امدید امید وارم که لحظات خوبی را سپری کنید❤️دنس فلوس 222 و دنس رست 230!"
}
...
class AdvancedBot(BaseBot):
    ...
    async def cmd_help(self, user: User, parts: list):
        help_text = (
            "<#FFD700>دستورات ربات:\n"
            "<#FFD700>1-6 - اجرای رقص\n"
            "<#FFD700>stop - توقف رقص\n"
            "<#FFD700>!help - نمایش راهنما\n"
            "<#FFD700>!spam تعداد پیام - ارسال پیام اسپم\n"
            "<#FFD700>!tele @username [vip|vip1|dj|مکان_سفارشی] - تلپورت کاربر\n"
            "<#FFD700>!tele to @username - تلپورت به کاربر\n"
            "<#FFD700>!tele me @username - تلپورت کاربر به ادمین\n"
            "<#FFD700>!tele me all - تلپورت همه به ادمین\n"
            "<#FFD700>!heart تعداد @username - ارسال قلب بنفش\n"
            "<#FFD700>!heart all - قلب بنفش به همه\n"
            "<#FFD700>!clap تعداد @username - ارسال clap\n"
            "<#FFD700>!clap all - clap به همه\n"
            "<#FFD700>!wink تعداد @username - ارسال wink\n"
            "<#FFD700>!wink all - wink به همه\n"
            "<#FFD700>!wave تعداد @username - ارسال wave\n"
            "<#FFD700>!wave all - wave به همه\n"
            "<#FFD700>!thumbs تعداد @username - ارسال thumbs-up\n"
            "<#FFD700>!thumbs all - thumbs-up به همه\n"
            "<#FFD700>!wallet - نمایش موجودی ربات\n"
            "<#FFD700>!set - تلپورت ربات به ادمین\n"
            "<#FFD700>!item set @username - تغییر ظاهر ربات به ایتم‌های کاربر\n"
            "<#FFD700>!tip <تعداد> all - تیپ به همه\n"
            "<#FFD700>!vip - تلپورت به VIP\n"
            "<#FFD700>!vip1 - تلپورت به VIP1\n"
            "<#FFD700>!dj - تلپورت به DJ\n"
            "<#FFD700>!down - تلپورت به پایین\n"
            "<#FFD700>!ban @username - بن کردن کاربر\n"
            "<#FFD700>!unban @username - آنبن کردن کاربر\n"
            "<#FFD700>!dancechain - اجرای زنجیره رقص\n"
            "<#FFD700>!addtele نام_مکان - ذخیره مکان جدید\n"
            "<#FFD700>!deltele نام_مکان - حذف مکان تلپورت\n"
            "<#FFD700>!welcome پیام - تنظیم پیام خوش‌آمدگویی\n"
            "<#FFD700>!addadmin @username - افزودن ادمین (فقط Host)\n"
            "<#FFD700>!removeadmin @username - حذف ادمین (فقط Host)\n"
            ...
            "<#FFD700>!listadd - نمایش لیست ادمین‌ها\n"
            "<#FFD700>!freeze @username - فریز کردن کاربر\n"
            "<#FFD700>!unfreeze @username - آزاد کردن کاربر از فریز\n"
            "<#FFD700>!party @username عدد - اجرای رقص اجباری برای کاربر\n"
            "<#FFD700>!party all عدد - اجرای رقص برای همه\n"
            "<#FFD700>!partys @username - توقف رقص اجباری کاربر\n\n"
